...
<TLDRBox>
    ...
    better on these tasks. Our <a href={Config.ARTIFEX_GITHUB_URL} rel='noreferrer' target='_blank'>
        Artifex Python library <i className='bi bi-box-arrow-up-right'></i>
...
<a className='btn btn-primary' href={Config.ARTIFEX_GITHUB_URL} target='_blank' rel='noreferrer'>See Artifex on GitHub <i className='bi bi-github ms-2'></i></a>