...
tags: ['task-specific LLM', 'offline NLP', 'text classification', 'local sentiment analysis', 'sentiment classification', 'privacy-first ML']
...
The `sentiment_analysis` method we used in the script above employs a small, pre-trained language 
...
the <a href={Config.SENTIMENT_ANALYSIS_HF_LINK} target='_blank' rel='noreferrer'>model's Hugging Face page</a>.
