---
title: 'Cut your chatbot cost and latency by 40% using small, self-hosted Guardrail models.'
...
### Cost & latency assessment of model that uses self-hosted guardrails
