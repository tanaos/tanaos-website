...
subtitle: 'Reduce your reliance on expensive API calls by offloading guardrail-specific queries to small guardrail models that run locally, without a GPU.'
...
models that run locally on our CPU, thereby **cutting chatbot costs by 43% and latency by 53%**, by
