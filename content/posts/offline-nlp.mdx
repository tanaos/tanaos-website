...
tasks belonging to the second category, such as text classification, entity recognition, sentiment analysis, etc. are
**simple enough to be performed offline** on a local device, without needing an internet connection.
