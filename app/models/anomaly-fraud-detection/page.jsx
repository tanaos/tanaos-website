...
const title = 'Anomaly & Fraud Detection | Tanaos';
const description = 'Detect fraudulent transactions and anomalies in financial and e-commerce data with a custom Small Language Model. Fast, private, and accurate.';
const url = `${Config.WEBSITE_BASE_URL}models/anomaly-fraud-detection/`;
...
# Load the custom anomaly & fraud detection model we created for you
pipeline(
    task="text-classification",
    model="your-org/anomaly-fraud-detector",
)

transactions = [
    {"amount": 1200, "country": "US", "user": "A"},
    {"amount": 5, "country": "RU", "user": "B"},
    {"amount": 300, "country": "US", "user": "C"},
    {"amount": 10000, "country": "CN", "user": "D"},
]
...
#   {"label": "fraud",   "confidence": 0.98},
#   {"label": "normal",  "confidence": 0.94},
#   {"label": "anomaly", "confidence": 0.97},
# ]`;

const CATEGORIES_EXAMPLE = [
    { input: "Amount: $1200, Country: US", label: "Normal", confidence: "95%" },
    { input: "Amount: $5, Country: RU", label: "Fraud", confidence: "98%" },
    { input: "Amount: $300, Country: US", label: "Normal", confidence: "94%" },
    { input: "Amount: $10000, Country: CN", label: "Anomaly", confidence: "97%" },
    { input: "Amount: $50, Country: US", label: "Normal", confidence: "96%" },
    { input: "Amount: $5000, Country: BR", label: "Fraud", confidence: "99%" },
];

export default function AnomalyFraudDetectionPage() {
    return (
        <div className={styles['page']}>
                ...
                <div className='row m-0 align-items-start'>
                    <div className='col-12 col-lg-6 p-0 pt-lg-2 d-flex flex-column justify-content-start'>
                        <div className={styles['hero-content']} style={{ textAlign: 'left', margin: 0, marginBottom: 0 }}>
                            <h1>
                                <b>Anomaly & Fraud Detection</b>
                            </h1>
                            <p className={styles['hero-subtitle']} style={{ textAlign: 'left', marginLeft: 0, marginRight: 0 }}>
                                Detect fraudulent transactions and anomalies in financial and e-commerce data — with a custom Small Language Model that runs on your CPU. No cloud dependency, no latency, no data leaving your infrastructure.
                            </p>
            ...
            <section className={`global-padding ${styles['section']}`}>
                <h2 className={`${styles['section-title']} ${styles['left']}`}>Why use our Anomaly & Fraud Detection model?</h2>
                <p className={`${styles['section-subtitle']} ${styles['left']}`}>
                    Other fraud detection solutions rely on your data being sent to third-party servers and generic models. With Tanaos, you get a custom model that runs entirely on your infrastructure, with no data leaving your servers.
                </p>
                <div className='row mt-5 g-4'>
                    <div className='col-12 col-md-4'>
                        <div className={styles['benefit-card']}>
                            ...
                            <h3>Blazing fast</h3>
                            <p>
                                Detect anomalies and fraud in under 100ms on a regular CPU. No GPU required, perfect for real-time applications.
                            </p>
                        </div>
                    </div>
                    <div className='col-12 col-md-4'>
                        <div className={styles['benefit-card']}>
                            ...
                            <p>
                                Runs entirely on your infrastructure. Sensitive financial data never leaves your servers.
                            </p>
                        </div>
                    </div>
                    <div className='col-12 col-md-4'>
                        <div className={styles['benefit-card']}>
                            ...
                            <p>
                                Trained specifically for your use case and fraud patterns. Outperforms generic models on your data.
                            </p>
                        </div>
                    </div>
                    <div className='col-12 col-md-4'>
                    ...
                    <div className='col-12 col-md-4'>
                        <div className={styles['benefit-card']}>
                            ...
                            <p>
                                A few lines of Python. Plug it into your backend or financial system in minutes.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section id='how-it-works' className={`global-padding ${styles['section']}`}>
                ...
                <p className={styles['section-subtitle']}>
                    Integrate the anomaly & fraud detection model we've created for you in your pipeline with just a few lines of code, using the Transformers library.
                </p>
                ...
                <div className={`row mt-5 g-4 ${styles['steps']}`}>
                    <div className='col-12 col-md-3'>
                        <div className={styles['step']}>
                            ...
                            <p>Tell us your fraud patterns, anomaly types, and any special requirements.</p>
                        </div>
                    </div>
                    <div className='col-12 col-md-3'>
                        <div className={styles['step']}>
            ...
            <section id='try-it-out' className={`global-padding ${styles['section']} ${styles['cta-section']}`}>
                <div className={styles['cta-card']}>
                    <h2><BsStars style={{ fontSize: '2rem', marginRight: '1rem', verticalAlign: 'middle' }} />Ready to detect fraud & anomalies?</h2>
                    <p>
