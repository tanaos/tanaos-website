import { BsArrowRight, BsCpu, BsShieldCheck, BsLightning, BsGlobe, BsCodeSlash, BsGraphUp, BsStars, BsExclamationTriangle } from 'react-icons/bs';
...
const title = 'Chatbot Safety & Moderation | Tanaos';
const description = 'Ensure your chatbot never returns unwanted or potentially dangerous responses. Small, fast, and private moderation models for safe AI deployments.';
const url = `${Config.WEBSITE_BASE_URL}models/chatbot-safety-moderation/`;
...
# Load the custom chatbot moderation model
pipeline(
    task="text-classification",
    model="your-org/chatbot-safety-moderation",
)
...
const CATEGORIES_EXAMPLE = [
    { input: "I'm sorry, I can't help with that.", label: "Safe", confidence: "98%" },
    { input: "Here's how to make a bomb...", label: "Unsafe", confidence: "99%" },
    { input: "Let's talk about something else.", label: "Safe", confidence: "97%" },
    { input: "You are stupid!", label: "Unsafe", confidence: "98%" },
    { input: "What is the weather today?", label: "Safe", confidence: "97%" },
    { input: "How do I hack an account?", label: "Unsafe", confidence: "99%" },
];

export default function ChatbotSafetyModerationPage() {
    return (
        <div className={styles['page']}>
                ...
                <div className='row m-0 align-items-start'>
                    <div className='col-12 col-lg-6 p-0 pt-lg-2 d-flex flex-column justify-content-start'>
                        <div className={styles['hero-content']}>
                            <h1>
                                Chatbot <b>Safety & Moderation</b>
                            </h1>
                            <p className={styles['hero-subtitle']}>
                                Ensure your chatbot never returns unwanted or potentially dangerous responses. Small, fast, and private moderation models for safe AI deployments.
                            </p>
            ...
            <section className={`global-padding ${styles['section']}`}>
                <h2 className={`${styles['section-title']} ${styles['left']}`}>Why use Chatbot Safety & Moderation?</h2>
                <p className={`${styles['section-subtitle']} ${styles['left']}`}>
                    Small, fine-tuned models can instantly flag or block unsafe, toxic, or policy-violating chatbot responses—without sending data to the cloud. Keep your users and brand safe.
                </p>
                <div className='row mt-5 g-4'>
                    <div className='col-12 col-md-4'>
                        <div className={styles['benefit-card']}>
                            ...
                            <h3>Blazing fast</h3>
                            <p>
                                Moderate responses in under 100ms on a regular CPU. No GPU required, perfect for real-time chat.
                            </p>
                        </div>
                    </div>
                    <div className='col-12 col-md-4'>
                    ...
                    <div className='col-12 col-md-4'>
                        <div className={styles['benefit-card']}>
                            ...
                            <p>
                                Trained specifically for your safety and moderation policies. Outperforms generic models on your data.
                            </p>
                        </div>
                    </div>
                    <div className='col-12 col-md-4'>
                    ...
                    <div className='col-12 col-md-4'>
                        <div className={styles['benefit-card']}>
                            ...
                            <h3>Multilingual</h3>
                            <p>
                                We can build models that work across languages, perfect for global chatbots.
                            </p>
                        </div>
                    </div>
                    <div className='col-12 col-md-4'>
                        <div className={styles['benefit-card']}>
                            ...
                            <p>
                                A few lines of Python. Plug it into your chatbot backend or moderation pipeline in minutes.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section id='try-it-out' className={`global-padding ${styles['section']} ${styles['cta-section']}`}>
                <div className={styles['cta-card']}>
                    <h2 className={styles['cta-title']}><BsStars className={styles['cta-icon']} />Ready to make your chatbot safe?</h2>
                    <p>
